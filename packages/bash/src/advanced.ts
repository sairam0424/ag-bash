/**
 * Full API surface — import from "@ag-bash/bash/advanced"
 *
 * This entry point re-exports every public symbol from the package.
 * Use this when you need access to internals like the parser, transform
 * pipeline, security modules, services, or network utilities.
 *
 * For a minimal surface, use "@ag-bash/bash/slim" instead.
 */
