/**
 * BashToolbox Registry
 *
 * Central registry for all agentic tools. Enforces schema validation
 * and provides metadata for AI SDKs. Delegates execution to the executor
 * module and schema conversion to the schema-conversion module.
 */
