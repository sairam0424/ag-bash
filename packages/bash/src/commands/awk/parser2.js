 ...
 */
import { AwkLexer, TokenType } from "./lexer.js";
...
export class AwkParser {
    ...
    parseStatement() {
        ...
        if (this.check(TokenType.DELETE)) {
            ...
            return { type: "delete", target: target };
        }
        // Print
    ...
    isConcatTerminator() {
        ...
        TokenType.AND, TokenType.OR, TokenType.QUESTION, 
        // Assignment operators
        TokenType.ASSIGN, TokenType.PLUS_ASSIGN, TokenType.MINUS_ASSIGN, TokenType.STAR_ASSIGN, TokenType.SLASH_ASSIGN, TokenType.PERCENT_ASSIGN, TokenType.CARET_ASSIGN, 
        // Expression terminators
        TokenType.COMMA, TokenType.SEMICOLON, TokenType.NEWLINE, TokenType.RBRACE, TokenType.RPAREN, TokenType.RBRACKET, TokenType.COLON, 
        // Redirection (in print context)
        TokenType.PIPE, TokenType.APPEND, 
