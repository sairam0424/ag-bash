    ...
    try {
        ...
        if (ctx.fs.readdirWithFileTypes) {
            ...
            for (const entry of entries) {
                ...
                const expanded = await expandRecursiveWithTypes(entryPath, ctx, includePatterns, excludePatterns, excludeDirPatterns, undefined, depth + 1);
                result.push(...expanded);
            }
        }
    }
...
export const fgrepFlagsForFuzzing = {
    name: "fgrep",
    flags: [],
    stdinType: "text",
    needsArgs: true,
};
export const egrepFlagsForFuzzing = {
    name: "egrep",
    flags: [],
    stdinType: "text",
    needsArgs: true,
