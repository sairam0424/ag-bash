 ...
 */
export function formatStrftime(format, timestamp, tz) {
...
function formatStrftimeDirective(date, directive, tz) {
    ...
    const weekNumber = getWeekNumberForParts(parts.year, parts.month, parts.day, parts.weekday, 0); // Sunday start
    const weekNumberMon = getWeekNumberForParts(parts.year, parts.month, parts.day, parts.weekday, 1); // Monday start
    switch (directive) {
        case "a":
