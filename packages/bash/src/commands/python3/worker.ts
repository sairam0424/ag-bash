...
/**
 * Create a HOSTFS backend that bridges to ag-bash's filesystem.
...
class _JbHttp:
    """HTTP client that bridges to ag-bash's secureFetch via custom FS"""
...
async function runPython(input: WorkerInput): Promise<WorkerOutput> {
  ...
  // Mount HOSTFS for ag-bash filesystem access
