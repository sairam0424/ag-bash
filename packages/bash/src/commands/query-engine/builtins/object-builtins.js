 ...
 */
import { asQueryRecord, isSafeKey, safeSet, sanitizeParsedData, } from "../safe-object.js";
 ...
 */
export function evalObjectBuiltin(value, name, args, ctx, evaluate) {
    switch (name) {
        case "keys":
        ...
        case "utf8bytelength": {
            ...
            const valueStr = typeName === "array" || typeName === "object"
                    ...
                    if (Array.isArray(current) && typeof key === "number") {
                        ...
                        if (obj) {
                            ...
                            if (obj[strKey] === null || obj[strKey] === undefined) {
                                safeSet(obj, strKey, typeof nextKey === "number" ? [] : Object.create(null));
                            }
                            current = obj[strKey];
                        }
                    }
