 ...
 */
export var SedTokenType;
((SedTokenType) => {
  // Addresses
  SedTokenType["NUMBER"] = "NUMBER";
  SedTokenType["DOLLAR"] = "DOLLAR";
  SedTokenType["PATTERN"] = "PATTERN";
  SedTokenType["STEP"] = "STEP";
  SedTokenType["RELATIVE_OFFSET"] = "RELATIVE_OFFSET";
  // Structure
  SedTokenType["LBRACE"] = "LBRACE";
  SedTokenType["RBRACE"] = "RBRACE";
  SedTokenType["SEMICOLON"] = "SEMICOLON";
  SedTokenType["NEWLINE"] = "NEWLINE";
  SedTokenType["COMMA"] = "COMMA";
  SedTokenType["NEGATION"] = "NEGATION";
  // Commands (single character)
  SedTokenType["COMMAND"] = "COMMAND";
  // Complex commands (parsed specially)
  SedTokenType["SUBSTITUTE"] = "SUBSTITUTE";
  SedTokenType["TRANSLITERATE"] = "TRANSLITERATE";
  SedTokenType["LABEL_DEF"] = "LABEL_DEF";
  SedTokenType["BRANCH"] = "BRANCH";
  SedTokenType["BRANCH_ON_SUBST"] = "BRANCH_ON_SUBST";
  SedTokenType["BRANCH_ON_NO_SUBST"] = "BRANCH_ON_NO_SUBST";
  SedTokenType["TEXT_CMD"] = "TEXT_CMD";
  SedTokenType["FILE_READ"] = "FILE_READ";
  SedTokenType["FILE_READ_LINE"] = "FILE_READ_LINE";
  SedTokenType["FILE_WRITE"] = "FILE_WRITE";
  SedTokenType["FILE_WRITE_LINE"] = "FILE_WRITE_LINE";
  SedTokenType["EXECUTE"] = "EXECUTE";
  SedTokenType["VERSION"] = "VERSION";
  SedTokenType["EOF"] = "EOF";
  SedTokenType["ERROR"] = "ERROR";
