...
import { getIfs, splitByIfsForRead, stripTrailingIfsWhitespace, } from "../helpers/ifs.js";
...
export function handleRead(ctx, args, stdin, stdinSourceFd = -1) {
    // Parse options
    let raw = false;
    let delimiter = "\n";
    let _prompt = "";
    ...
    let arrayName = null; // -a option: read into array
