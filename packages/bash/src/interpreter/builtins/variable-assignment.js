 ...
 */
export async function setVariable(ctx, assignment, options = {}) {
 ...
 */
export function markLocalVarDepth(ctx, name) {
 ...
 */
export function getLocalVarDepth(ctx, name) {
 ...
 */
export function clearLocalVarDepth(ctx, name) {
 ...
 */
export function pushLocalVarStack(ctx, name, currentValue) {
 ...
 */
export function popLocalVarStack(ctx, name) {
    const stack = ctx.state.localVarStack?.get(name);
 ...
 */
export function clearLocalVarStackForScope(ctx, scopeIndex) {
