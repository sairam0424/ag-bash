 ...
 */
export async function handleArrayDefaultValue(ctx, wordParts) {
 ...
 */
export async function handleArrayPatternWithPrefixSuffix(ctx, wordParts, hasArrayAtExpansion, expandPart, expandWordPartsAsync) {
 ...
 */
export async function handleArrayWithPrefixSuffix(ctx, wordParts, hasArrayAtExpansion, expandPart) {
    if (!hasArrayAtExpansion ||
        wordParts.length !== 1 ||
        wordParts[0].type !== "DoubleQuoted") {
        return null;
