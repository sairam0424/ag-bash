 ...
 */
export function patternHasCommandSubstitution(pattern) {
    let i = 0;
 ...
 */
export function expandVariablesInPattern(ctx, pattern) {
    let result = "";
    let i = 0;
    while (i < pattern.length) {
        const c = pattern[i];
 ...
 */
export async function expandVariablesInPatternAsync(ctx, pattern) {
    let result = "";
    let i = 0;
    while (i < pattern.length) {
        const c = pattern[i];
