...
import { getArrayIndices, getAssocArrayKeys, unquoteKey, } from "../helpers/array.js";
 ...
 */
export function getArrayElements(ctx, arrayName) {
 ...
 */
export function isArray(ctx, name) {
 ...
 */
export async function getVariable(ctx, name, checkNounset = true, _insideDoubleQuotes = false) {
 ...
 */
export async function isVariableSet(ctx, name) {
