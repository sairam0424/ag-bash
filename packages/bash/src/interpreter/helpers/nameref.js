 ...
 */
export function isNameref(ctx, name) {
    return ctx.state.namerefs?.has(name) ?? false;
}
/**
 * Mark a variable as a nameref
 */
export function markNameref(ctx, name) {
 ...
 */
export function unmarkNameref(ctx, name) {
 ...
 */
export function markNamerefInvalid(ctx, name) {
 ...
 */
export function markNamerefBound(ctx, name) {
 ...
 */
export function targetExists(ctx, target) {
 ...
 */
export function resolveNameref(ctx, name, maxDepth = 100) {
 ...
 */
export function getNamerefTarget(ctx, name) {
    if (!isNameref(ctx, name)) {
        return undefined;
    }
 ...
 */
export function resolveNamerefForAssignment(ctx, name, valueBeingAssigned, maxDepth = 100) {
    // If not a nameref, return as-is
    if (!isNameref(ctx, name)) {
        return name;
    }
