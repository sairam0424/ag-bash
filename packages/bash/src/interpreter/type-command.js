 ...
 * type [-afptP] name...
 */
export async function handleType(ctx, args, findFirstInPath, findCommandInPath) {
    // Parse options
 ...
 */
export async function handleCommandV(ctx, names, _showPath, verboseDescribe) {
    let stdout = "";
    let stderr = "";
    let exitCode = 0;
    for (const name of names) {
 ...
 */
export async function findFirstInPath(ctx, name) {
