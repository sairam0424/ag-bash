...
import { isPrivateIp, isUrlAllowed, matchesAllowListEntry, validateAllowList, } from "./allow-list.js";
import { MethodNotAllowedError, NetworkAccessDeniedError, RedirectNotAllowedError, ResponseTooLargeError, TooManyRedirectsError, } from "./types.js";
 ...
 */
export function createSecureFetch(config) {
    ...
    const denyPrivateRanges = config.denyPrivateRanges ??
    ...
    async function secureFetch(url, options = {}) {
        ...
        const effectiveTimeout = options.timeoutMs !== undefined
...
function buildMergedHeaders(userHeaders, firewallHeaders) {
    ...
    if (!firewallHeaders)
        return userHeaders;
    const merged = userHeaders instanceof Headers
