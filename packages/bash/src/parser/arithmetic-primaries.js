 ...
 */
export function skipArithWhitespace(input, pos) {
 ...
 */
export function parseArithNumber(str) {
 ...
 */
export function parseNestedArithmetic(parseArithExpr, p, input, currentPos) {
 ...
 */
export function parseAnsiCQuoting(input, currentPos) {
 ...
 * Returns the numeric value of the string content
 */
export function parseLocalizationQuoting(input, currentPos) {
    if (input.slice(currentPos, currentPos + 2) !== '$"') {
        return null;
    }
    let pos = currentPos + 2; // Skip $"
