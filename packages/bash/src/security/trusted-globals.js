 ...
 * so that ag-bash infrastructure can use them. They bypass all defense
 * protections.
 *
 ...
 */
export const _SharedArrayBuffer = globalThis.SharedArrayBuffer;
export const _Atomics = globalThis.Atomics;
export const _performanceNow = performance.now.bind(performance);
export const _Headers = globalThis.Headers;
