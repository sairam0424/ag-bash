...
const SKIP_PATH_PATTERNS = [
  ...
  // Generated, gitignored mirror of packages/* served as static website data
  // (regenerated by `pnpm fetch-agent-data`). Linting these duplicates the
  // source scan and produces phantom violations after each regeneration.
  /(^|\/)examples\/website\/public\/agent-data(\/|$)/,
];
...
const SKIP_PATTERNS = [
  ...
  /src\/.*\.js$/, // Generated JS in src (esbuild/tsc artifacts)
  /src\/.*\.d\.ts$/, // Generated d.ts in src
