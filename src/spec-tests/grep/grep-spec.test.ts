/**
 * Vitest runner for grep spec tests
 *
 * This runs the imported spec tests from BusyBox
 * against ag-bash's grep implementation.
 */

import * as fs from "node:fs";
import * as path from "node:path";
import { describe, expect, it } from "vitest";
import { parseGrepTestFile } from "./parser.js";
import { formatError, runGrepTestCase } from "./runner.js";
